...
import { ArrowLeft, Save, Calendar, Wallet, CheckCircle, Info } from "lucide-react";
...
function ReceivePaymentContent() {
  ...
  const initialPartyId = searchParams.get("party_id") || searchParams.get("customer_id") || "";
      ...
      <div className="p-6 max-w-[1200px] mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[var(--text-muted)] mt-0.5">
                Record incoming customer payment receipt, allocate against open invoices, or record as advance.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/payments"
              className="px-4 py-2 text-xs font-semibold text-[var(--text-secondary)] border border-[var(--border)] rounded-xl hover:bg-[var(--card-bg)] transition-colors flex items-center gap-2"
            >
        ...
        <div className="bg-[var(--card-bg)] border border-[var(--border)] rounded-2xl p-6 shadow-sm space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="space-y-1">
              <label className="text-xs font-medium text-[var(--text-muted)]">Current Running Balance</label>
...
export default function ReceivePaymentPage() {
  return (
    <Suspense fallback={<div className="p-12 text-center text-xs text-[var(--text-muted)]">Loading Receive Payment Page...</div>}>
