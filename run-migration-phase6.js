...
async function run() {
  ...
  try {
    ...
    const migrationPath = path.join(__dirname, 'supabase', 'migrations', '20260704000000_phase6_sales_billing.sql');
    const sql = fs.readFileSync(migrationPath, 'utf8');
    
    console.log("Executing Phase 6 database migration SQL...");
