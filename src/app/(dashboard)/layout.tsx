    ...
    <AuthProvider>
      <CompanyProvider>
        ...
        <div className={cn(
          ...
          {/* Content View */}
          <main className="flex-1 overflow-y-auto overflow-x-hidden bg-[var(--page-bg)] text-[var(--text-body)] px-3 sm:px-6 lg:px-8 pt-[calc(3.5rem+env(safe-area-inset-top,0px))] sm:pt-24 pb-[calc(5rem+env(safe-area-inset-bottom,0px))] md:pb-8 relative print:p-0 print:m-0 print:bg-white print:overflow-visible overscroll-y-contain">
