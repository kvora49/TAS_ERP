  ...
  return (
    ...
    >
      <div className="p-6 max-w-[1400px] mx-auto space-y-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-[var(--text-primary)] flex items-center gap-2">
                ...
                Direct Payment Linking (Customer-to-Supplier Contra)
              </h1>
              <p className="text-xs text-[var(--text-muted)] mt-0.5">
                Settle customer payment receipts directly against supplier or job worker invoices without creating duplicate cash or bank transactions.
              </p>
            </div>
          </div>
        ...
        {/* Info Banner */}
        <div className="p-4 bg-[var(--primary-light)] border border-[var(--primary)]/30 rounded-2xl flex items-start gap-3 text-xs text-[var(--text-primary)]">
