...
function MakePaymentContent() {
  ...
  const initialPartyId = searchParams.get("party_id") || searchParams.get("supplier_id") || searchParams.get("worker_id") || "";
...
export default function MakePaymentPage() {
  return (
    <Suspense fallback={<div className="p-12 text-center text-xs text-[var(--text-muted)]">Loading Make Payment Page...</div>}>
      <MakePaymentContent />
    </Suspense>
  );
}
