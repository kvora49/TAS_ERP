          ...
          <div className="bg-slate-900 text-white border border-slate-800 rounded-xl p-5 shadow-lg w-full max-w-sm space-y-3">
            ...
            <div className="space-y-2 text-xs font-semibold">
              <div className="flex justify-between">
                ...
                <span className="text-sm font-extrabold">₹{amountReceived.toLocaleString("en-IN", { minimumFractionDigits: 2 })}</span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                <span className="text-slate-400">To Advance Balance:</span>
